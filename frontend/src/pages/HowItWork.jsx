...
import howItWorksImg from "../assets/images/hwt.png"

const steps = [
  {
    id: 1,
    title: "Choose the best loan offers",
    content:
      "We work with a network of banks/lenders to provide the best offers at the lowest interest rates.",
  },
  {
    id: 2,
    title: "Apply online in 5 minutes",
    content:
      "Fill out a simple application form to get started with your loan process.",
  },
  {
    id: 3,
    title: "Complete your application",
    content: "Submit necessary documents and verify your identity to proceed.",
  },
  {
    id: 4,
    title: "Get your loan disbursed",
    content:
      "Once approved, your loan amount will be credited to your account.",
  },
];
      ...
      <Row className="justify-content-center align-items-center">
        <Col lg={5} md={6} sm={12}>
          ...
          <p className="text-center text-muted">
            Complete your loan application in minutes. No lineups, No waiting,
